FROM tomcat:9.0.50-jdk8-openjdk as develop
...
COPY --from=ticblue/backend-jdk8-maven6_3:dev $HOME/api/target/api-1.0-SNAPSHOT.war /usr/local/tomcat/webapps/ultravision#api.war
